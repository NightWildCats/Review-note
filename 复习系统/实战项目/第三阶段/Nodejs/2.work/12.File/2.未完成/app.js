...
//可以获取上传文件的文件名的 路由文件
var loadFiles = require('./routes/loadfiles.js');
app.use('/updatename',loadFiles);

// 通过ajax 请求来进行文件上传
var ajaxFile = require('./routes/ajaxfile.js');
app.use('/ajax',ajaxFile);

//通过ajax 请求的方式 来进行 多文件的上传
var ajaxFiles = require('./routes/ajaxfiles.js');
app.use('/ajaxs',ajaxFiles);
